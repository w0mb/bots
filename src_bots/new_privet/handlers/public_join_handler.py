...
# from handlers.helpers.join_funcs import is_user_member
...
#                         await bot.send_video(event.new_chat_member.user.id, video, caption=caption, parse_mode=ParseMode.HTML, reply_markup=kb)
#                     elif self.welcome_text:
#                         await bot.send_message(event.new_chat_member.user.id, self.welcome_text, parse_mode=ParseMode.HTML, reply_markup=kb)
#
