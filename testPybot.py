...
bot = Bot(token="7585535782:AAErAJuZzvuFhdIzRMDigZuij15__wHXnSo")
dp = Dispatcher(bot)
...
action_keyboard = InlineKeyboardMarkup(inline_keyboard=[[action1_button], [action2_button]])
...
@dp.callback_query_handler(lambda query: query.data == "action1")
...
@dp.callback_query_handler(lambda query: query.data == "pay_action1")
...
@dp.callback_query_handler(lambda query: query.data == "go_to_payment")
...
@dp.callback_query_handler(lambda query: query.data == "payment_done")
...
@dp.callback_query_handler(lambda query: query.data.startswith("approve_access:"))
async def approve_access_handler(query: types.CallbackQuery):
    await query.answer()
    user_id = int(query.data.split(":")[1])
    access_link = "https://t.me/+lKF6jVTI4QJhYzAy"
    try:
...
@dp.callback_query_handler(lambda query: query.data == "back_to_actions")
...
@dp.callback_query_handler(lambda query: query.data == "action2")
...
@dp.callback_query_handler(lambda query: query.data == "pay_action2")
...
@dp.callback_query_handler(lambda query: query.data == "go_to_payment2")
...
@dp.callback_query_handler(lambda query: query.data == "payment_done2")
